...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /home/kerr_gavin/notes<cr>")
--
...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"/home/kerr_gavin/notes\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"/home/kerr_gavin/notes\"}<cr>")
--
...
--
-- for review workflow
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /home/kerr_gavin/notes/accepted<cr>:bd<cr>")
